...
Partial Class Dashboard
    ...
    Private Sub InitializeComponent()
        ...
        Dashboard_InfoLbl_learners = New Label()
        Dashboard_InfoLbl2_learners = New Label()
        Dashboard_InfoBox_revenue = New Panel()
        Dashboard_InfoLbl_revenue = New Label()
        Dashboard_InfoBox2_revenue = New Panel()
        Dashboard_InfoLbl2_revenue = New Label()
        Dashboard_InfoBox_Lessons = New Panel()
        Dashboard_InfoLbl_Lessons = New Label()
        Dashboard_InfoBox2_Lessons = New Panel()
        Dashboard_InfoLbl2_Lessons = New Label()
        Dashboard_InfoBox2_learners = New Panel()
        Dashboard_InfoBox_Pass = New Panel()
        Dashboard_InfoLbl_Pass = New Label()
        Dashboard_InfoBox2_Pass = New Panel()
        Dashboard_InfoLbl2_Pass = New Label()
        DMenuIcon_Logout = New PictureBox()
        DMenuName_BookLessons = New Label()
        DMenuName_Courses = New Label()
        DMenuName_Trainers = New Label()
        DMenuIcon_Trainers = New PictureBox()
        DHeadIcon_Title = New PictureBox()
        Dashboard_InfoBox_courses = New Panel()
        Dashboard_InfoLbl_courses = New Label()
        Dashboard_InfoBox2_courses = New Panel()
        Dashboard_InfoLbl2_courses = New Label()
        DMenuName_Learners = New Label()
        DMenuName_Dashboard = New Label()
        DMenuIcon_Dashboard = New PictureBox()
        ...
        Dashboard_InfoBox_trainers = New Panel()
        Dashboard_InfoLbl_trainers = New Label()
        Dashboard_InfoBox2_trainers = New Panel()
        Dashboard_InfoLbl2_trainers = New Label()
        ...
        Dashboard_InfoBox2_Lessons.SuspendLayout()
        Dashboard_InfoBox2_learners.SuspendLayout()
        Dashboard_InfoBox_Pass.SuspendLayout()
        Dashboard_InfoBox2_Pass.SuspendLayout()
        CType(DMenuIcon_Logout, ComponentModel.ISupportInitialize).BeginInit()
        CType(DMenuIcon_Trainers, ComponentModel.ISupportInitialize).BeginInit()
        CType(DHeadIcon_Title, ComponentModel.ISupportInitialize).BeginInit()
        Dashboard_InfoBox_courses.SuspendLayout()
        Dashboard_InfoBox2_courses.SuspendLayout()
        ...
        Dashboard_InfoBox2_trainers.SuspendLayout()
        Dashboard_Panel.SuspendLayout()
        Dashboard_InfoBox_learners.SuspendLayout()
        CType(DMenuIcon_BookLessons, ComponentModel.ISupportInitialize).BeginInit()
        CType(DMiniBtn_Icon, ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' Dashboard_InfoLbl_learners
        ' 
        Dashboard_InfoLbl_learners.AutoSize = True
        Dashboard_InfoLbl_learners.BackColor = Color.Transparent
        Dashboard_InfoLbl_learners.Font = New Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Dashboard_InfoLbl_learners.ForeColor = Color.FromArgb(CByte(56), CByte(56), CByte(56))
        Dashboard_InfoLbl_learners.Location = New Point(116, 120)
        Dashboard_InfoLbl_learners.Name = "Dashboard_InfoLbl_learners"
        Dashboard_InfoLbl_learners.Size = New Size(89, 21)
        Dashboard_InfoLbl_learners.TabIndex = 15
        Dashboard_InfoLbl_learners.Text = "LEARNERS"
        ' 
        ' Dashboard_InfoLbl2_learners
        ' 
        ...
        Dashboard_InfoLbl2_learners.TabIndex = 16
        Dashboard_InfoLbl2_learners.Text = "07"
        ' 
        ...
        Dashboard_InfoBox_revenue.Name = "Dashboard_InfoBox_revenue"
        Dashboard_InfoBox_revenue.Size = New Size(320, 160)
        Dashboard_InfoBox_revenue.TabIndex = 16
        ' 
        ' Dashboard_InfoLbl_revenue
        ' 
        Dashboard_InfoLbl_revenue.AutoSize = True
        Dashboard_InfoLbl_revenue.BackColor = Color.Transparent
        Dashboard_InfoLbl_revenue.Font = New Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Dashboard_InfoLbl_revenue.ForeColor = Color.FromArgb(CByte(56), CByte(56), CByte(56))
        Dashboard_InfoLbl_revenue.Location = New Point(120, 120)
        Dashboard_InfoLbl_revenue.Name = "Dashboard_InfoLbl_revenue"
        Dashboard_InfoLbl_revenue.Size = New Size(83, 21)
        Dashboard_InfoLbl_revenue.TabIndex = 15
        Dashboard_InfoLbl_revenue.Text = "REVENUE"
        ' 
        ...
        Dashboard_InfoBox2_revenue.Size = New Size(310, 100)
        Dashboard_InfoBox2_revenue.TabIndex = 0
        ' 
        ' Dashboard_InfoLbl2_revenue
        ' 
        ...
        Dashboard_InfoLbl2_revenue.TabIndex = 16
        Dashboard_InfoLbl2_revenue.Text = "£ 1,020"
        ' 
        ...
        Dashboard_InfoBox_Lessons.Name = "Dashboard_InfoBox_Lessons"
        Dashboard_InfoBox_Lessons.Size = New Size(320, 160)
        Dashboard_InfoBox_Lessons.TabIndex = 16
        ' 
        ' Dashboard_InfoLbl_Lessons
        ' 
        Dashboard_InfoLbl_Lessons.AutoSize = True
        Dashboard_InfoLbl_Lessons.BackColor = Color.Transparent
        Dashboard_InfoLbl_Lessons.Font = New Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Dashboard_InfoLbl_Lessons.ForeColor = Color.FromArgb(CByte(56), CByte(56), CByte(56))
        Dashboard_InfoLbl_Lessons.Location = New Point(86, 120)
        Dashboard_InfoLbl_Lessons.Name = "Dashboard_InfoLbl_Lessons"
        Dashboard_InfoLbl_Lessons.Size = New Size(148, 21)
        Dashboard_InfoLbl_Lessons.TabIndex = 15
        Dashboard_InfoLbl_Lessons.Text = "BOOKED LESSONS"
        ' 
        ...
        Dashboard_InfoBox2_Lessons.Size = New Size(310, 100)
        Dashboard_InfoBox2_Lessons.TabIndex = 0
        ' 
        ' Dashboard_InfoLbl2_Lessons
        ' 
        ...
        Dashboard_InfoLbl2_Lessons.TabIndex = 16
        Dashboard_InfoLbl2_Lessons.Text = "36"
        ' 
        ...
        Dashboard_InfoBox2_learners.Size = New Size(310, 100)
        Dashboard_InfoBox2_learners.TabIndex = 0
        ' 
        ...
        Dashboard_InfoBox_Pass.Location = New Point(841, 370)
        Dashboard_InfoBox_Pass.Name = "Dashboard_InfoBox_Pass"
        Dashboard_InfoBox_Pass.Size = New Size(320, 160)
        Dashboard_InfoBox_Pass.TabIndex = 16
        ' 
        ' Dashboard_InfoLbl_Pass
        ' 
        Dashboard_InfoLbl_Pass.AutoSize = True
        Dashboard_InfoLbl_Pass.BackColor = Color.Transparent
        Dashboard_InfoLbl_Pass.Font = New Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Dashboard_InfoLbl_Pass.ForeColor = Color.FromArgb(CByte(56), CByte(56), CByte(56))
        Dashboard_InfoLbl_Pass.Location = New Point(127, 120)
        Dashboard_InfoLbl_Pass.Name = "Dashboard_InfoLbl_Pass"
        Dashboard_InfoLbl_Pass.Size = New Size(66, 21)
        Dashboard_InfoLbl_Pass.TabIndex = 15
        Dashboard_InfoLbl_Pass.Text = "PASS %"
        ' 
        ...
        Dashboard_InfoBox2_Pass.Size = New Size(310, 100)
        Dashboard_InfoBox2_Pass.TabIndex = 0
        ' 
        ' Dashboard_InfoLbl2_Pass
        ' 
        ...
        Dashboard_InfoLbl2_Pass.TabIndex = 16
        Dashboard_InfoLbl2_Pass.Text = "91 %"
        ' 
        ' DMenuIcon_Logout
        ' 
        ...
        DMenuName_BookLessons.TabIndex = 28
        DMenuName_BookLessons.Text = "Book Lessons"
        ' 
        ' DMenuName_Courses
        ' 
        ...
        DMenuName_Courses.Text = "Courses"
        ' 
        ' DMenuName_Trainers
        ' 
        ...
        DMenuName_Trainers.Text = "Trainers"
        ' 
        ' DMenuIcon_Trainers
        ' 
        ...
        Dashboard_InfoBox_courses.Name = "Dashboard_InfoBox_courses"
        Dashboard_InfoBox_courses.Size = New Size(320, 160)
        Dashboard_InfoBox_courses.TabIndex = 18
        ' 
        ' Dashboard_InfoLbl_courses
        ' 
        Dashboard_InfoLbl_courses.AutoSize = True
        Dashboard_InfoLbl_courses.BackColor = Color.Transparent
        Dashboard_InfoLbl_courses.Font = New Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Dashboard_InfoLbl_courses.ForeColor = Color.FromArgb(CByte(56), CByte(56), CByte(56))
        Dashboard_InfoLbl_courses.Location = New Point(120, 120)
        Dashboard_InfoLbl_courses.Name = "Dashboard_InfoLbl_courses"
        Dashboard_InfoLbl_courses.Size = New Size(81, 21)
        Dashboard_InfoLbl_courses.TabIndex = 15
        Dashboard_InfoLbl_courses.Text = "COURSES"
        ' 
        ...
        Dashboard_InfoBox2_courses.Size = New Size(310, 100)
        Dashboard_InfoBox2_courses.TabIndex = 0
        ' 
        ' Dashboard_InfoLbl2_courses
        ' 
        ...
        Dashboard_InfoLbl2_courses.TabIndex = 16
        Dashboard_InfoLbl2_courses.Text = "5"
        ' 
        ' DMenuName_Learners
        ' 
        ...
        DMenuName_Learners.Text = "Learners"
        ' 
        ' DMenuName_Dashboard
        ' 
        ...
        DMenuName_Dashboard.TabIndex = 20
        DMenuName_Dashboard.Text = "Dashboard"
        ' 
        ' DMenuIcon_Dashboard
        ' 
        ...
        ' DCloseBtn_Icon
        ' 
        DCloseBtn_Icon.BackColor = Color.Transparent
        DCloseBtn_Icon.Image = CType(resources.GetObject("DCloseBtn_Icon.Image"), Image)
        DCloseBtn_Icon.InitialImage = CType(resources.GetObject("DCloseBtn_Icon.InitialImage"), Image)
        DCloseBtn_Icon.Location = New Point(1214, 9)
        DCloseBtn_Icon.Name = "DCloseBtn_Icon"
        DCloseBtn_Icon.Size = New Size(14, 14)
        DCloseBtn_Icon.SizeMode = PictureBoxSizeMode.StretchImage
        DCloseBtn_Icon.TabIndex = 18
        DCloseBtn_Icon.TabStop = False
        ' 
        ' AppLogoTitle
        ' 
        ...
        Dashboard_InfoBox_trainers.Name = "Dashboard_InfoBox_trainers"
        Dashboard_InfoBox_trainers.Size = New Size(320, 160)
        Dashboard_InfoBox_trainers.TabIndex = 17
        ' 
        ' Dashboard_InfoLbl_trainers
        ' 
        Dashboard_InfoLbl_trainers.AutoSize = True
        Dashboard_InfoLbl_trainers.BackColor = Color.Transparent
        Dashboard_InfoLbl_trainers.Font = New Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Dashboard_InfoLbl_trainers.ForeColor = Color.FromArgb(CByte(56), CByte(56), CByte(56))
        Dashboard_InfoLbl_trainers.Location = New Point(117, 120)
        Dashboard_InfoLbl_trainers.Name = "Dashboard_InfoLbl_trainers"
        Dashboard_InfoLbl_trainers.Size = New Size(86, 21)
        Dashboard_InfoLbl_trainers.TabIndex = 15
        Dashboard_InfoLbl_trainers.Text = "TRAINERS"
        ' 
        ...
        Dashboard_InfoBox2_trainers.Size = New Size(310, 100)
        Dashboard_InfoBox2_trainers.TabIndex = 0
        ' 
        ' Dashboard_InfoLbl2_trainers
        ' 
        ...
        Dashboard_InfoLbl2_trainers.TabIndex = 16
        Dashboard_InfoLbl2_trainers.Text = "12"
        ' 
        ' Dashboard_Panel
        ' 
        ...
        Dashboard_Panel.Controls.Add(Dashboard_InfoBox_courses)
        Dashboard_Panel.Controls.Add(Dashboard_InfoBox_Pass)
        Dashboard_Panel.Controls.Add(Dashboard_InfoBox_revenue)
        Dashboard_Panel.Controls.Add(Dashboard_InfoBox_Lessons)
        Dashboard_Panel.Controls.Add(Dashboard_InfoBox_trainers)
        Dashboard_Panel.Controls.Add(Dashboard_InfoBox_learners)
        Dashboard_Panel.Location = New Point(10, 62)
        Dashboard_Panel.Name = "Dashboard_Panel"
        Dashboard_Panel.Size = New Size(1220, 662)
        Dashboard_Panel.TabIndex = 15
        ' 
        ...
        Dashboard_InfoBox_learners.Name = "Dashboard_InfoBox_learners"
        Dashboard_InfoBox_learners.Size = New Size(320, 160)
        Dashboard_InfoBox_learners.TabIndex = 0
        ' 
        ' DMenuIcon_BookLessons
        ' 
        ...
        Controls.Add(DMenuName_Courses)
        Controls.Add(DMenuName_Trainers)
        Controls.Add(DMenuIcon_Trainers)
        Controls.Add(DMenuName_Learners)
        Controls.Add(DMenuName_Dashboard)
        ...
        Controls.Add(DMenuIcon_BookLessons)
        FormBorderStyle = FormBorderStyle.None
        Icon = CType(resources.GetObject("$this.Icon"), Icon)
        Name = "Dashboard"
        StartPosition = FormStartPosition.CenterScreen
        Text = "Dashboard"
        Dashboard_InfoBox_revenue.ResumeLayout(False)
        Dashboard_InfoBox_revenue.PerformLayout()
        Dashboard_InfoBox2_revenue.ResumeLayout(False)
        Dashboard_InfoBox2_revenue.PerformLayout()
        Dashboard_InfoBox_Lessons.ResumeLayout(False)
        Dashboard_InfoBox_Lessons.PerformLayout()
        Dashboard_InfoBox2_Lessons.ResumeLayout(False)
        Dashboard_InfoBox2_Lessons.PerformLayout()
        Dashboard_InfoBox2_learners.ResumeLayout(False)
        Dashboard_InfoBox2_learners.PerformLayout()
        Dashboard_InfoBox_Pass.ResumeLayout(False)
        Dashboard_InfoBox_Pass.PerformLayout()
        Dashboard_InfoBox2_Pass.ResumeLayout(False)
        Dashboard_InfoBox2_Pass.PerformLayout()
        CType(DMenuIcon_Logout, ComponentModel.ISupportInitialize).EndInit()
        CType(DMenuIcon_Trainers, ComponentModel.ISupportInitialize).EndInit()
        CType(DHeadIcon_Title, ComponentModel.ISupportInitialize).EndInit()
        Dashboard_InfoBox_courses.ResumeLayout(False)
        Dashboard_InfoBox_courses.PerformLayout()
        Dashboard_InfoBox2_courses.ResumeLayout(False)
        Dashboard_InfoBox2_courses.PerformLayout()
        ...
        Dashboard_InfoBox_trainers.PerformLayout()
        Dashboard_InfoBox2_trainers.ResumeLayout(False)
        Dashboard_InfoBox2_trainers.PerformLayout()
        Dashboard_Panel.ResumeLayout(False)
        Dashboard_Panel.PerformLayout()
        Dashboard_InfoBox_learners.ResumeLayout(False)
        Dashboard_InfoBox_learners.PerformLayout()
        CType(DMenuIcon_BookLessons, ComponentModel.ISupportInitialize).EndInit()
        CType(DMiniBtn_Icon, ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
        PerformLayout()
    End Sub

    Friend WithEvents Dashboard_InfoLbl_learners As Label
    Friend WithEvents Dashboard_InfoLbl2_learners As Label
    Friend WithEvents Dashboard_InfoBox_revenue As Panel
    Friend WithEvents Dashboard_InfoLbl_revenue As Label
    Friend WithEvents Dashboard_InfoBox2_revenue As Panel
    Friend WithEvents Dashboard_InfoLbl2_revenue As Label
    Friend WithEvents Dashboard_InfoBox_Lessons As Panel
    Friend WithEvents Dashboard_InfoLbl_Lessons As Label
    Friend WithEvents Dashboard_InfoBox2_Lessons As Panel
    Friend WithEvents Dashboard_InfoLbl2_Lessons As Label
    Friend WithEvents Dashboard_InfoBox2_learners As Panel
    Friend WithEvents Dashboard_InfoBox_Pass As Panel
    Friend WithEvents Dashboard_InfoLbl_Pass As Label
    Friend WithEvents Dashboard_InfoBox2_Pass As Panel
    Friend WithEvents Dashboard_InfoLbl2_Pass As Label
    Friend WithEvents DMenuIcon_Logout As PictureBox
    Friend WithEvents DMenuName_BookLessons As Label
    Friend WithEvents DMenuName_Courses As Label
    Friend WithEvents DMenuName_Trainers As Label
    Friend WithEvents DMenuIcon_Trainers As PictureBox
    Friend WithEvents DHeadIcon_Title As PictureBox
    Friend WithEvents Dashboard_InfoBox_courses As Panel
    Friend WithEvents Dashboard_InfoLbl_courses As Label
    Friend WithEvents Dashboard_InfoBox2_courses As Panel
    Friend WithEvents Dashboard_InfoLbl2_courses As Label
    Friend WithEvents DMenuName_Learners As Label
    Friend WithEvents DMenuName_Dashboard As Label
    Friend WithEvents DMenuIcon_Dashboard As PictureBox
    ...
    Friend WithEvents Dashboard_InfoBox_trainers As Panel
    Friend WithEvents Dashboard_InfoLbl_trainers As Label
    Friend WithEvents Dashboard_InfoBox2_trainers As Panel
    Friend WithEvents Dashboard_InfoLbl2_trainers As Label
